...
export function Tile({ cell, animate, delayIndex = 0 }: Props) {
  ...
  return (
    <div
      className={clsx(
        "grid-cell-size flex items-center justify-center rounded-md border leading-tight transition-colors duration-150 px-1",
        bgClass,
        textClass,
        borderClass,
    ...
    >
      <span className="tile-value grid-cell-text text-center break-words">
        {revealed ? value : ""}
